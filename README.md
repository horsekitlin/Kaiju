...
## Skill
We use python framework named flask and nodejs

## Quick Start

~~~sh
# getting the code
git clone git@github.com:nko4/kaiju.git && cd ./kaiju/

# developing
npm install
npm start

# deploying (to http://kaiju.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@kaiju.2013.nodeknockout.com
ssh root@kaiju.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@kaiju.2013.nodeknockout.com
ssh -i ./id_deploy root@kaiju.2013.nodeknockout.com

## Python Flask Quick Start(deb), listen 5000 port
sudo apt-get install python-pip
pip install -r requiredment.txt
python run.py
python ChatRoom/chatroom.py

## Nodejs Quick Start, listen 3000 port
npm install
node kaiju.js
